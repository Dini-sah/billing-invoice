  ...
  return (
    <div className="grid gap-4 bg-white px-5 py-4 transition hover:bg-slate-50 lg:grid-cols-[48px_1fr_1.2fr_.8fr_.8fr_.8fr_.8fr_.8fr_.8fr_.8fr] lg:items-center">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-xs capitalize text-slate-500 lg:hidden">{invoice.type}</p>
      </div>
      <div className="min-w-0">
      ...
      <p className="text-sm font-bold text-slate-950">{formatCurrency(invoice.total)}</p>
      <p className="text-sm font-semibold text-emerald-700">{formatCurrency(paid)}</p>
      <p className="hidden text-sm font-semibold text-rose-700 lg:block">{formatCurrency(due)}</p>
      <div className="flex items-center justify-between gap-3 lg:justify-end">
        <p className="text-sm font-semibold text-rose-700 lg:hidden">{formatCurrency(due)}</p>
